...
import com.angesh.walmartapp.activity.RegisterActivity
import com.angesh.walmartapp.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        userInputList.add(User("Angesh", "Pokharel", "angeshpokharel@gmail.com", "test123"))
        userInputList.add(User("Ramesh", "Basnet", "ramesh@gmail.com", "test123"))
        userInputList.add(User("Dhurba", "Singh", "dhurba@gmail.com", "test123"))
        userInputList.add(User("Deepak", "Baskota", "deepak@gmail.com", "test123"))
        userInputList.add(User("Dinesh", "Shrestha", "dinesh@gmail.com", "test123"))
                ...
                userInputList.forEach {
                    if (it == user) {
                        ...
                        startActivity(Intent(
                            this,
                            UserShoppinCategory::class.java
                        ).apply {
